...
class SBtabDocument:
    ...
    def reactionSBtab(self):
        ...
        try:
            ...
            self.warnings.append('Warning: Please be aware that the SBtab -> SBML conversion does not include a validation of the provided kinetic rate laws. If they are invalid, this affects the validity of the output SBML.')
        except: pass
